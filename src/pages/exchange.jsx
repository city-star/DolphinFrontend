...
function Exchange() {
  ...
  return (
    <div className="flex min-h-screen bg-black text-white">
      <Sidebar title="Exchange" />
      <div className="w-full flex flex-col lg:ml-64 ">
        <Header />
        <div className="w-full  flex items-center justify-center bg-black mt-16">
          <div className="flex flex-col items-center justify-center">
            <div className="shadow-lg rounded-lg w-full max-w-[1200px] p-10  bg-black">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-8">
                {exchanges.map((exchange) => (
                  <div
                    ...
                    className={`relative flex flex-col items-center justify-center cursor-pointer p-6 rounded-lg ${
                      selectedExchange === exchange.exchangeName
                        ? "border-4 border-blue-600"
                        : "border border-blue-800"
                    } transition-all duration-300 transform ${
                      exchange.status ? "hover:bg-blue-950 hover:scale-105" : ""
                    } bg-black text-white`}
                  ...
                  >
                    ...
                    {!exchange.status && (
                      <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-80 rounded-lg">
                        <div className="px-3 py-1 text-xs font-medium text-center text-blue-400 bg-blue-900 rounded-full animate-pulse">
                          Inactive
                        </div>
                      </div>
                    )}
